...
<head>
    ...
    <title>Recuperar contraseña - Pinterest</title>
...
<body class="bg-gray-50 min-h-screen flex items-center justify-center p-4">
    <div class="w-full max-w-md">
        <div class="bg-white rounded-2xl shadow-lg p-8">
            ...
            <h1 class="text-center text-2xl font-semibold text-gray-900 mb-2">Recuperar contraseña</h1>
            <p class="text-center text-sm text-gray-600 mb-6">Introduce tu email y te enviaremos un enlace para restablecer tu contraseña.</p>
