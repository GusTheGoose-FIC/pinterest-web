...
<body class="bg-white flex flex-col min-h-screen">
  <nav class="flex items-center justify-between px-6 py-3 shadow-sm">
    <div class="flex items-center space-x-2">
      ...
      <h1 class="text-[#000000ff] font-bold text-lg">Empresa</h1>
    </div>

    <div class="flex items-center space-x-6 text-blue-700 font-medium">
      <a href="#" class="hover:underline">Por que Pinterest</a>
      <a href="#" class="hover:underline">Crea contenido</a>
      <a href="#" class="hover:underline">Crea anuncio</a>
      <a href="#" class="hover:underline">Novedades + insights</a>
  ...
  <main class="flex-grow">
    <h2 class="px-6 py-10 text-lg text-gray-800">contenido de creacion</h2>
    <h3>aqui ponen todo lo que hagan</h3>
  </main>
