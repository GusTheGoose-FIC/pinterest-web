...
<body class="bg-white flex flex-col min-h-screen">
  <nav class="flex items-center justify-between px-6 py-3 shadow-sm">
    ...
    <div class="flex items-center space-x-6 text-blue-700 font-medium">
      <a href="{{ route('Información') }}" class="hover:underline">Para tu marca</a>
      <a href="{{ route('empresa') }}" class="hover:underline">Empieza hoy mismo</a>
      <a href="#" class="hover:underline">Funciones + herramientas</a>
